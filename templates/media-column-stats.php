			...
			<div class="kraken-stats-saved">
				...
				<?php if ( $summary['total'] ) : ?>
					...
					<div class="kraken-stats-action">
						<a href="" class="kraken-action-show-details"><?php esc_html_e( 'Show Details', 'kraken-io' ); ?></a>
					...
					<?php if ( $stats['show_reset'] ) : ?>
						<div class="kraken-stats-action">
							<a href="" class="kraken-action-reset" data-id="<?php echo esc_attr( $stats['id'] ); ?>"><?php esc_html_e( 'Reset Image', 'kraken-io' ); ?></a>
						</div>
					<?php endif; ?>
